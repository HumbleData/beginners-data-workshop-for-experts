...
### About the repository's material
This repository is designed for librarians, administrators, researchers, and professionals seeking to enhance their data skills within their own fields. The materials cover a range of topics, including data analysis, visualization, and machine learning, using Python libraries such as pandas, Matplotlib, and scikit-learn. It aims to provide targeted examples and exercises that address real-world scenarios encountered in various professional domains.
...
1. Go to [https://githubtocolab.com/HumbleData/beginners-data-workshop-for-experts](https://githubtocolab.com/HumbleData/beginners-data-workshop-for-experts)
...
6. After that copy and paste the following codes in the new cell:
   ```
   !git clone https://github.com/HumbleData/beginners-data-workshop-for-experts.git
   !cp -r beginners-data-workshop-for-experts/media/ .
   !cp -r beginners-data-workshop-for-experts/data/ .
   !cp -r beginners-data-workshop-for-experts/solutions/ .
   !rm -r beginners-data-workshop-for-experts/
   ```
...
```bash
git clone https://github.com/HumbleData/beginners-data-workshop-for-experts.git
cd beginners-data-workshop-for-experts
```
...
2. Create a new environment named 'humble-data':
   ```bash
   conda create -n humble-data python=3.8 #todo: check the Python version the repo's notebooks are using
   ```
